...
@Service
public class LoadDynamicDictionary {

    private static final Logger logger = Logger.getLogger(LoadDynamicDictionary.class.getName());
    ...
    public LoadDynamicDictionary(){
        initDicConfig();
        init();
    }

    //手动执行触发更新外部字典
    public void loadDynamicDictionary(){
        clearDic();
        initDicConfig();
        init();
        logger.info("TASK-UPDATE DYNAMIC DIC END!");
    }
    ...
    //进行字典配置读取
    public static void initDicConfig(){
        BufferedReader br = null;
        try {
            br = new BufferedReader(new InputStreamReader(new FileInputStream(new File("./config/dic.properties"))));
        } catch (FileNotFoundException e) {
            System.err.println("READ DYNAMIC CONFIG ERROR, NO THIS CONFIG: " + e);
        }
        ...
        if (br != null) {
            try {
                while ((temp = br.readLine()) != null) {
                    ...
                    System.out.println("###dynamic-config: " + temp);
                }
                br.close();
            } catch (IOException e) {
                System.err.println("READ DYNAMIC CONFIG ERROR: " + e);
                e.printStackTrace();
            }
        }
    ...
    //初始化公共函数
    private static void initLoad(String typePaths, String type){
    ...
    //加载分词字典
    private static Forest loadSegDic(String path, String nature){
        ...
        try {
            ...
            System.err.println("READ DYNAMIC SEG ERROR, NO THIS FILE. PATH[" + path + "] ERROR: " + e);
        }
        ...
        if (br != null) {
            ...
            logger.info("###[DIC-SEG-DYNAMIC]###The dic of Seg[" + path + "] is loaded, the num of dic is: " + count);
            return forest;
    ...
    //加歧义词字典
    private static Forest loadAmbigDic(String path){
        ...
        try {
            ...
            System.err.println("READ DYNAMIC AMBIG ERROR, NO THIS FILE. PATH[" + path + "] ERROR: " + e);
        }
            ...
            try {
                while ((temp = br.readLine()) != null) {
                    if (StringUtil.isNotBlank(temp)) {
                        ...
                        if (split.length % 2 != 0) {
                            LIBRARYLOG.error("init dynamic ambiguity error in line :" + temp + " format err !");
                        }
                ...
                System.err.println("READ DIC-SEG-DYNAMIC ERROR: " + e);
                e.printStackTrace();
            }

            logger.info("###[DIC-AMBIG-DYNAMIC]###The dic of Ambig[" + path + "] is loaded, the num of dic is: " + count);
            return forest;
        } else {
            return null;
        }
    ...
    //加载停用词字典
    private static List<String> loadStopDic(String path){
        ...
        try {
            ...
            System.err.println("READ DYNAMIC STOP ERROR, NO THIS FILE. PATH[" + path + "] ERROR: " + e);
        }
        ...
        if (br != null) {
            ...
            try {
                ...
                System.err.println("READ DIC-STOP-DYNAMIC ERROR: " + e);
                e.printStackTrace();
            }

            logger.info("###[DIC-STOP-DYNAMIC]###The dic of Stop[" + path + "] is loaded, the num of dic is: " + count);
            return list;
        } else {
            return null;
        }
    ...
    //加载同义词字典
    private static Map<String, String> loadSynonDic(String path){
        ...
        try {
            ...
            System.err.println("READ DYNAMIC SYNON ERROR, NO THIS FILE. PATH[" + path + "] ERROR: " + e);
        }
        ...
        if (br != null) {
            ...
            try {
                ...
                System.err.println("READ DIC-SYNON-DYNAMIC ERROR: " + e);
                e.printStackTrace();
            }

            logger.info("###[DIC-SYNON-DYNAMIC]###The dic of Synon[" + path + "] is loaded, the num of dic is: " + count);
            return map;
        } else {
            return null;
        }
    ...
    //加载特俗字典
    private static Set<String> loadSpeDic(String path) {
        ...
        try {
            ...
            System.err.println("READ DYNAMIC SPE ERROR, NO THIS FILE. PATH[" + path + "] ERROR: " + e);
        }
        ...
        if (br != null) {
            ...
            try {
                ...
                System.err.println("READ DIC-SPE-DYNAMIC ERROR: " + e);
                e.printStackTrace();
            }

            logger.info("###[DIC-SPE-DYNAMIC]###The dic of Spe[" + path + "] is loaded, the num of dic is: " + count);
            return set;
        } else {
            return null;
        }
