...
<head>
    <meta charset="utf-8">
    <title>数据虫巢 - 政务舆情 - 江西·赣州·定南 - 问政舆情</title>
    <!-- 引入 echarts.js -->
...
<body>
    ...
    <div class="contentBk nyBk">
        ...
        <div class="box mb25">
            当前位置：  <a href="/gov/addr_type?a_id=111">政务舆情</a>　>>　<a href="/gov/addr_type?a_id=111">江西·赣州·定南</a>　>>　<a href=/gov/jx_gz_dn/politics>问政舆情</a>
        </div>
       ...
       <div style="width: 100%;height:8px;"></div>
        ...
        <div class="box mb25">
            ...
            <div class = "box" style="width: 100%; height:400px">
                <div id="div_type" style="width: 48%;float: left;height:400px;"></div>
           ...
           <!----------咨询人&情感分析------------->
           <div class = "box" style="width: 100%; height:400px">
                <div id="div_ask" style="width: 48%;float: left;height:400px;"></div>
                <div style="width: 4%;float: left;height:350px;"></div>
    ...
    <script type="text/javascript">
            ...
            var myChart = echarts.init(document.getElementById('div_type'));
            var context  = eval('${data.type}');
            // 指定图表的配置项和数据
           option = {
               title : {
                   text: '问政类型分布图',
                   subtext: ' --自[${data.time}]起，政府系统问政类型分布'
               },
               tooltip : {
                   trigger: 'item',
    ...
    <script type="text/javascript">
        // 基于准备好的dom，初始化echarts实例
        var myChart = echarts.init(document.getElementById('div_ask'));
        var context  = eval('${data.ask}');
        //名称数组
        ...
        option = {
            title : {
                text: '问政咨询人问政次数Top${data.ask_top}',
                subtext: ' --自[${data.time}]起，问政涉及的咨询人问政次数'
            },
            tooltip : {
                trigger: 'axis'
            },
    ...
    <script type="text/javascript">
        ...
        option = {
            title : {
                text: '问政情感分析',
                subtext: ' --自[${data.time}]起，问政情感分析结果'
            },
            tooltip : {
                trigger: 'axis'
            },
    ...
    <script type="text/javascript">
        ...
        option = {
              title:{
                  text:"问政特征情感词云分布",
                  subtext: ' --自[${data.time}]起，问政情感特征分布'
              },
              tooltip: {},
                toolbox: {
                    show: true,
