...
<head>
    <meta charset="utf-8">
    <title>数据虫巢 - 政务舆情 - ${data.a_name}</title>
    <!-- 引入 echarts.js -->
...
<body>
    ...
    <div class="contentBk nyBk">
        ...
        <div class="box mb25">
            当前位置：  政务舆情 >> <a href=${data.a_url}>${data.a_name}</a>
        </div>
            ...
            <div class="listL">
				<ul class="imgnewslist">
                 <c:forEach items="${data.list_main}" var="ds">
                        <li class="cf">
                        <div class="imgbox fl"><a href="${ds.t_url}"><img src="${ds.t_images}" alt="${ds.t_title}"/></a></div>
                        <div class="titAbs fr">
                                <h2 class="tit"><a href="${ds.t_url}">${ds.t_title}</a></h2>
                                <span class="abs"> >> ${ds.t_desc} <em class="time"><a href="${ds.t_url}">【查看详情】</a></em></span>
                            </div>
                        </li>
                   </c:forEach>
				</ul>
